 ...
 * {@link PtFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link PtFragment#newInstance} factory method to
...
public class PtFragment extends Fragment {
    ...
    public static PtFragment newInstance(String param1, String param2) {
        PtFragment fragment = new PtFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewPager.setAdapter(new PtPagerAdapter(getChildFragmentManager()));
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        inflater.inflate(R.menu.toolbar_pt, menu);
    ...
    private void _setAppBar(View view) {
        ...
        toolbar.setBackgroundColor(getResources().getColor(R.color.colorPrimary_Pt));
        toolbar.setTitle(R.string.app_clinic_pt_title);

        //view.bringToFront() ;
        //getWindow().setStatusBarColor(getResources().getColor(R.color.colorPrimaryDark_Pt));
