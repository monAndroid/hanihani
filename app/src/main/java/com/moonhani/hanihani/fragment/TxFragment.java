...
public class TxFragment extends Fragment {
    ...
    public interface OnFragmentInteractionListener {
        ...
        void onTxFragmentInteraction(Uri uri);
    }
    ...
    public static TxFragment newInstance(String param1, String param2) {
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        inflater.inflate(R.menu.toolbar_tx, menu);
    ...
    private void _setAppBar(View view) {
        ...
        toolbar.setBackgroundColor(ContextCompat.getColor(getContext(), R.color.colorPrimary_Tx));
        toolbar.setTitle(R.string.app_clinic_tx_title);
        ...
        //ab.setTitle("치료 관리");
        //ab.setTitle(R.string.app_clinic_tx_title);
    }

    // TODO: Rename method, update argument and hook method into UI event
    public void onButtonPressed(Uri uri) {
        if (mListener != null) {
            mListener.onTxFragmentInteraction(uri);
        }
    }
